import { ListSmartComponent } from '@angular-enterprise-stack/ghx-marketplace/feat-list';
import { SearchSmartComponent } from '@angular-enterprise-stack/ghx-marketplace/feat-search';
